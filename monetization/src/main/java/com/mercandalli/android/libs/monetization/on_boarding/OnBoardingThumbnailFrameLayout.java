...
public class OnBoardingThumbnailFrameLayout extends FrameLayout {
    ...
    public OnBoardingThumbnailFrameLayout(final Context context) {
        super(context);
        init(context, null, 0);
    }

    public OnBoardingThumbnailFrameLayout(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public OnBoardingThumbnailFrameLayout(final Context context, final AttributeSet attrs, final int defStyleAttr) {
